...
SqlPkg requires that you already have the .NET 10.0 runtime installed, which you can get at [https://dotnet.microsoft.com/en-us/download](https://dotnet.microsoft.com/en-us/download).

**Note:** Microsoft SqlPackage uses .NET 8.0.11, so you need to install that in addition to .NET 10.
